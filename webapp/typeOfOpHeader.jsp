...
<!-- 
 ...
 -->
		...
		<form action="ControllerServlet?action=typeOfOpMain" method="post"
			enctype="application/x-www-form-urlencoded" name="frmTypeOfOp"
			target="mainFrameTypeOfOp" id="frmTypeOfOp">
			<!--<div align="center">
			...
			<div align="center">
                ...
                <tr>
                   <th class= "td_header" width="100%" colspan=4 >TIPO DE OPERACIÓN</th>
                </tr>
					<tr>
						<td width="50%">
							<div align="center">
