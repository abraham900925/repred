    ...
    <body>
        <%
            ...
            if(rbtnUpdateOpType != null) {
                ...
                out.println(
                    "<form action=\"ControllerServlet?action=updateTypeOfOp\" method=\"post\" enctype=\"application/x-www-form-urlencoded\" name=\"frmUpdateTypeOfOp\" target=\"mainFrameTypeOfOp\" id=\"frmUpdateTypeOfOp\">" +
                    "        <div align=\"center\">" +
                ...
                query =
                    ...
                    "WHERE ID_TIPO_OPERACION = '" + opTypeID + "'";
