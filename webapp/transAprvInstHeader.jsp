<%
/*###############################################################################
# Nombre del Programa :  transAprvInstHeader.jsp                                #
# Autor               :  JOAQUIN MOJICA                                         #
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  C-08-089-07                       FECHA:30/10/2008     #
# Descripcion General :	 Pantalla que muestra Transacciones Aprobadas Por       #
#                        Institución STAT05                                     #
# Programa Dependiente:  transAprvInst.jsp                                      #
...
<!--  
		<div align="center">
			<strong>Transacciones Aprobadas Por Institución STAT05</strong>
		</div>
-->
		<form action="ControllerServlet?action=transAprvInstMain" method="post"
			enctype="application/x-www-form-urlencoded" name="frmTransAprvInst"
			target="mainFrameTransAprvInst" id="frmTransAprvInst">
			<div align="center">
                ...
                <tr>
                   <th class= "td_header" width="100%" colspan=4 >TRANSACCIONES APROBADAS POR INSTITUCION STAT05</th>
                </tr>
					<tr>
						<td>
							<div align="center">
								...
								<input name="txtfStartDate" type="text" id="txtfStartDate"
									tabindex="1" size="15" />
                        		<a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmTransAprvInst.txtfStartDate);return false;" HIDEFOCUS>
						...
						<td>
							<div align="center">
								...
								<input name="txtfEndDate" type="text" id="txtfEndDate"
									tabindex="2" size="15" />
                        		<a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmTransAprvInst.txtfEndDate);return false;" HIDEFOCUS>
