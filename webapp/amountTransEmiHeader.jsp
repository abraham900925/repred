<%
/*###############################################################################
# Nombre del Programa :  amountTransEmiHeader.jsp                               #
...
#                                                                               #
# Programa Dependiente:  amountTransEmi.jsp                                     #
...
<!-- 
 ...
 -->
		<form action="ControllerServlet?action=amountTransEmiMain" method="post"
			...
			<!---- Marca del Cambio : WELL-JMQ-C-04-2006-14  Inicia la Modificacion   12/06/2014 --->
                ...
                <tr>
                   <th class= "td_header" width="100%" colspan=4 >IMPORTE DE TRANSACCIONES EMISOR STATO7_IT</th>
                </tr>
					<tr>
						<td>
							<div align="center">
