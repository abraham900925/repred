<%
/*###############################################################################
# Nombre del Programa :  numTransEmiHeader.jsp                                  #
# Autor               :  JOAQUIN MOJICA                                         #
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  C-08-089-07                       FECHA:30/10/2008     #
# Descripcion General :	 Pantalla que muestra No. Transacciones Emisor STAT07_NT#
#                                                                               #
# Programa Dependiente:  numTransEmi.jsp                                        #
...
-->
		<form action="ControllerServlet?action=numTransEmiMain" method="post"
			...
			<div align="center">
                ...
                <tr>
                   <th class= "td_header" width="100%" colspan=4 >TRANSACCIONES EMISOR STAT07_NT</th>
                </tr>
					<tr>
						<td>
							<div align="center">
