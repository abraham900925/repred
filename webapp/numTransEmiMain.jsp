<%
/*###############################################################################
# Nombre del Programa :  numTransEmiMain.jsp                                    #
...
<%!
    ...
    */
    ...
    //--------------------------------------------------------------------------------    
    String[] colsReport = {
        "Fecha", "Banco", "Retiros MN", "Retiros Dlls", "Venta Gen.","Pago Elec.","Consultas", "Camb. Nip", "Rechazos", "Retenidas" ,"Tranfer","Depositos","Ult. Movs.","Surcharge"};   
    //--------------------------------------------------------------------------------
    ...
    void resultTable(javax.servlet.jsp.JspWriter out) {
        try {
            out.println(
                ...
                + "        <td>"
                + "		    <div align=\"center\">"
                + "				<form action=\"ControllerServlet?action=showBIRTNumTransEmi\" method=\"post\" target=\"mainFrameAmountTransAdq\" name=\"frmBIRTTransAdq\" id=\"frmBIRTTransAdq\">"
            ...
            */
            ...
            if(numResults > 0) {
                ...
                */
                ...
                out.println("&nbsp&nbsp<a href=\"numTransEmiMain.jsp?paginacion=P\">Previos</a>");
                out.println("&nbsp&nbsp<a href=\"numTransEmiMain.jsp?paginacion=N\">Siguientes</a>");
                out.println("<br><br>");
                resultTable(out);
            }//IF numResults > 0
        /**
