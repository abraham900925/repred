...
<!--  
		<div align="center">
			<strong>Depurar Acumulados Diarios </strong>
		</div>
-->
		<br><br>
		<form action="ControllerServlet?action=" method="post"
			enctype="application/x-www-form-urlencoded" name="frmDailyUnload"
			target="mainFrame" id="frmDailyUnload">
			<div align="center">
				<table width="40%" border="0" cellspacing="0" cellpadding="0" class="tbl_border" >
                <tr>
                   <th class= "td_header" width="100%" colspan=4 >DEPURAR ACUMULADOS DIARIOS<br></th>
                </tr>
					<tr>
						<td>
							<div align="center">
