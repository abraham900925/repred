<%
/*###############################################################################
# Nombre del Programa :  amountTransEmiMain.jsp                                    #
...
<%!
    ...
    */
    ...
    int numResults = 0;
    String[] colsReport = {
            "Fecha", "Banco adq", "Banco emi", "Tipo Operacion", "nombre", "Cuenta Cheques", "Cuenta ahorro", "Cuenta Credito","Surcharge"};
    ...
    void resultTable(javax.servlet.jsp.JspWriter out) {
        try {
            out.println(
                ...
                + "        <td>"
                + "		    <div align=\"center\">"
                + "				<form action=\"ControllerServlet?action=showBIRTAmountTransEmi\" method=\"post\" target=\"mainFrameAmountTransAdq\" name=\"frmBIRTTransAdq\" id=\"frmBIRTTransAdq\">"
    ...
    <%
        ...
        */
			...
			*/	
            ...
            query =
                "SELECT " +
                "FECHA, CODIGO_BANCO_ADQ, CODIGO_BANCO_EMI, CODIGO_TIPO_OPERACION, NOMBRE, CTA_CHEQUES, CTA_AHORRO, CTA_CREDITO, TRANFEE " +
                "FROM TBL_SRR_REP_STAT07_IT " +
				...
				---------------------------------------------------------------------------------
				*/	 
				"AND CODIGO_BANCO_EMI IN('" + (role.equals("bancoint") ? txtfFiid : bancosEmiStr) + "')";
				/*
				---------------------------------------------------------------------------------
				-- Marca del Cambio : WELL-JMQ-P-02-0472-13 Termina la Modificacion   30/07/2014 -
				---------------------------------------------------------------------------------
            ...
            query =
				...
				---------------------------------------------------------------------------------
				*/	 
				"AND CODIGO_BANCO_EMI IN('" +  bancosEmiStr + "')";
				/*
				---------------------------------------------------------------------------------
            ...
            */
            ...
            if(numResults > 0) {
                ...
                */
                ...
                out.println("&nbsp&nbsp<a href=\"amountTransEmiMain.jsp?paginacion=P\">Previos</a>");
                out.println("&nbsp&nbsp<a href=\"amountTransEmiMain.jsp?paginacion=N\">Siguientes</a>");
                out.println("<br><br>");
                resultTable(out);
            }//IF numResults > 0
        /**
