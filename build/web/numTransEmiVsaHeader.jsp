<%
/*###############################################################################
# Nombre del Programa :  numTransEmiVsaHeader.jsp                               #
...
-->
		<form action="ControllerServlet?action=numTransEmiVsaMain" method="post"
			...
			<div align="center">
                ...
                <tr>
                   <th class= "td_header" width="100%" colspan=4 >TRANSACCIONES EMISOR STAT07_NT - VISA</th>
                </tr>
					<tr>
						<td>
							<div align="center">
