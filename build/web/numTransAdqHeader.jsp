...
<!--  
		<div align="center">
			<strong>No. Transacciones Adquiriente STAT06_NT</strong>
		</div>
-->
		<form action="ControllerServlet?action=numTransAdqMain" method="post"
			...
			target="mainFrameNumTransAdq" id="frmNumTransAdq">
			<div align="center">
			<!---- Marca del Cambio : WELL-JMQ-C-04-2006-14  Inicia la Modificacion   12/06/2014 --->
                ...
                <tr>
                   <th class= "td_header" width="100%" colspan=4>TRANSACCIONES ADQUIRIENTE STAT06_NT</th>
                </tr>
					<tr>
						<td>
							<div align="center">
								...
								<input name="txtfStartDate" type="text" id="txtfStartDate"
									tabindex="1" size="15" />
                        		<a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmNumTransAdq.txtfStartDate);return false;" HIDEFOCUS>
						...
						<td>
							<div align="center">
								...
								<input name="txtfEndDate" type="text" id="txtfEndDate"
									tabindex="2" size="15" />
                        		<a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmNumTransAdq.txtfEndDate);return false;" HIDEFOCUS>
