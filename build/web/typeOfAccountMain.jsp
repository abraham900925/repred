    ...
    */
    void resultTable(javax.servlet.jsp.JspWriter out) {
        try {
            ...
            out.println("<form action=\"ControllerServlet?action=updateTypeOfAcc\" method=\"post\" name=\"frmUpdateTypeOfAcc\" id=\"frmUpdateTypeOfAcc\" target=\"mainFrameTypeOfAccount\">");
    ...
    <%
        ...
        */
            ...
            */
            ...
            query =
                "SELECT " +
                "ID_TIPO_CUENTA, CODIGO_TIPO_CUENTA, NOMBRE, DESCRIPCION " +
                "FROM " + TBL_ACC_TYPE;
            ...
            */
            ...
            if(numResults > 0) {
                ...
                */
                ...
                out.println("&nbsp&nbsp<a href=\"typeOfAccountMain.jsp?paginacion=P\">Previos</a>");
                out.println("&nbsp&nbsp<a href=\"typeOfAccountMain.jsp?paginacion=N\">Siguientes</a>");
                out.println("<br><br>");
                resultTable(out);
            }//IF numResults > 0
        /**
