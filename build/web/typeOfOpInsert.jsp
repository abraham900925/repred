...
<html>
    ...
    <body>
        ...
        btnInsertOp = request.getParameter("btnInsertOp");
            ...
            if(btnInsertOp == null) {
                out.println(
                    "<form action=\"ControllerServlet?action=insertTypeOfOp\" method=\"post\" enctype=\"application/x-www-form-urlencoded\" name=\"frmInsertOp\" target=\"mainFrame\" id=\"frmInsertOp\">" +
                    "        <div align=\"center\">" +
                    "            <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"tbl_border\">" +
                    "                <tr>" +
                    "				 <th class= \"td_header\" width=\"100%\" colspan=4 >AGREGAR TIPO DE OPERACIÓN</th>" +
                    "                </tr>" + 
                ...
                if(html.validateFields().size() != 0) {
	                ...
	                query =
	                	"INSERT INTO " + TBL_OP_TYPE +
	                	" (CODIGO_TIPO_OPERACION, NOMBRE, DESCRIPCION) " +
